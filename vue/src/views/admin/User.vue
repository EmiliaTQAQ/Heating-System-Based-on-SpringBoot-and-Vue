  ...
  <div>
    ...
    <div style="width: 100%" >
      <el-table :data="tableData"  border :row-class-name="tableRowClassName" :header-cell-style="{'text-align':'center'}" :cell-style="{'text-align':'center'}">
        ...
        <el-table-column prop="address" label="地址" width="125px"></el-table-column>
        <el-table-column prop="living_space" label="住房面积"></el-table-column>
      ...
      <el-dialog title="请填写信息" :visible.sync="dialogFormVisible" width="30%">
        <el-form :model="form">
          ...
          <el-form-item label="余额" label-width="15%">
            <el-input v-model="form.balance" autocomplete="off" style="width: 90%"></el-input>
          </el-form-item>
          <el-form-item label="住址" label-width="15%">
            <el-select v-model="form.cell" placeholder="请选择" style="width: 25%"  @change="selectChanged">
              <el-option
            ...
            小区
            <el-select v-model="form.building" placeholder="请选择" style="width: 25%"  @change="selectChanged1">
              <el-option
                  v-for="item in typeObjs1"
                  :key="item"
                  :label="item"
                  :value="item">
              </el-option>
            ...
            号楼
            <el-select v-model="form.gate" placeholder="请选择" style="width: 25%"  @change="selectChanged2">
              <el-option
                  v-for="item in typeObjs2"
                  :key="item"
                  :label="item"
                  :value="item">
              </el-option>
          ...
          <el-form-item label="住房面积" label-width="15%">
            <el-input v-model="form.living_space" autocomplete="off" style="width: 90%"></el-input>
          </el-form-item>
    ...
    <div>
      <el-dialog title="请填写信息" :visible.sync="dialogFormVisible1" width="30%">
        <el-form :model="form1">
          <el-form-item label="账号" label-width="15%">
            <el-input v-model="form1.account" autocomplete="off" style="width: 90%" disabled></el-input>
          </el-form-item>
          <el-form-item label="姓名" label-width="15%">
          ...
          <el-form-item label="年龄" label-width="15%">
            <el-input v-model="form1.age" autocomplete="off" style="width: 90%"></el-input>
          </el-form-item>
          <el-form-item label="余额" label-width="15%">
            <el-input v-model="form1.balance" autocomplete="off" style="width: 90%"></el-input>
          </el-form-item>
          <el-form-item label="住址" label-width="15%">
            <el-select v-model="form1.cell" placeholder="请选择" style="width: 25%"  @change="selectChanged">
              <el-option
                  v-for="item in typeObjs"
                  :key="item"
                  :label="item"
            ...
            小区
            <el-select v-model="form1.building" placeholder="请选择" style="width: 25%"  @change="selectChanged1">
              <el-option
                  v-for="item in typeObjs1"
                  :key="item"
                  :label="item"
            ...
            号楼
            <el-select v-model="form1.gate" placeholder="请选择" style="width: 25%"  @change="selectChanged2">
              <el-option
                  v-for="item in typeObjs2"
                  :key="item"
                  :label="item"
          ...
          <el-form-item label="住房面积" label-width="15%">
            <el-input v-model="form1.living_space" autocomplete="off" style="width: 90%"></el-input>
          </el-form-item>
          <el-form-item label="电话" label-width="15%">
            <el-input v-model="form1.phone" autocomplete="off" style="width: 90%"></el-input>
          </el-form-item>
          <el-form-item label="密码" label-width="15%">
            <el-input v-model="form1.password" autocomplete="off" style="width: 90%"></el-input>
          </el-form-item>
        </el-form>
        <div slot="footer" class="dialog-footer">
...
export default {
  ...
  methods: {
    ...
    selectChanged(value) {
      ...
      this.x = value
      console.log(this.x)
      request.get("/room/x/" + this.x).then(res => {
        if (res.code === '0') {
    ...
    selectChanged1(value) {
      ...
      request.get("/room/y/" + this.y).then(res => {
        if (res.code === '0') {
    ...
    selectChanged2(value) {
      this.z = value
      this.form1.address =  this.x  + "小区"+  this.y + "号楼" +  this.z
      this.form.address =  this.x  + "小区"+  this.y + "号楼" +  this.z
    ...
    edit(obj) {
      this.form1 = JSON.parse(JSON.stringify(obj))
    ...
    submit1() {
      this.form1.address =  this.x  + "小区"+  this.y + "号楼" +  this.z
      this.form1.role = 'user'
      let reg = /^1[0-9]{10}$/;
      if (this.form1.age < 100 && this.form1.age > 0) {
        if(this.form1.balance < 0) {
          ...
          if (!reg.test(this.form1.phone)) {
            ...
            request.post("/user", this.form1).then(res => {
              if (res.code === '0') {
                this.$message({
                  message: '操作成功',
                  type: 'success'
